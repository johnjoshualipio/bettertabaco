    ...
    <section class="civic-section" aria-labelledby="contact-hotlines-title">
        <div class="civic-container civic-contact-layout">
            <div>
                ...
                <p class="civic-source-note">Verify numbers and current office information against the <a href="{{ config('civic.sources.about') }}" target="_blank" rel="noreferrer noopener">official source <x-civic.icon name="arrow-up-right" class="civic-icon--inline size-4" /></a> before relying on them.</p>
            </div>
